        ...
        fetch(url)  
            ...
            .then((data) => {
               ...
               //console.log(icon);
                ...
                setBaseVisual(iter, visual, num, baseNum);
...
function setBaseVisual(iter, visual, num, baseNum) {
    ...
    if(iter == 0) {
        ...
        .forEach(elem =>  {console.log(elem); elem.style.background = `linear-gradient(135deg, #56cd, #6add)`}); 
    }
...
function dayOrNight(firstDate) {
    ...
    (dayValues.includes(parseInt(Monthday)))? // czy Monthday to g. 9, 12, 15, a może 18?
